...
Kit de la clase de Spec-Driven Development. Incluye nueve skills basadas en Matt Pocock y la skill original **no-tecnico**. El ejemplo es material de trabajo: no incluye una aplicación de reservas implementada ni pruebas de esa aplicación ya ejecutadas.

## Empezá acá

1. Leé [la guía del alumno](docs/guia-alumno.md).
...
- `.scratch/tutorias/`: spec activa v1, snapshots v1/v2, plan y tickets. La carpeta es oculta en algunos exploradores; activá “mostrar archivos ocultos”.
- `docs/guia-alumno.md`: instalación, invocación y práctica.
- `docs/guia-docente.md`: notas de las 30 slides; se genera desde la fuente de la web.
