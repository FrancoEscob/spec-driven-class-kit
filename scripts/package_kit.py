...
adaptations = {
    ...
    'grill-with-docs': 'Carga por archivo y compatibilidad con no-tecnico.',
    'grilling': 'Investigación local cuando no hay delegación autorizada.',
    'code-review': 'Alternativa secuencial sin subagentes autorizados.',
